...
hoistedDependencies:
  ...
  '@types/pngjs@6.0.5':
    '@types/pngjs': private
  '@vitejs/plugin-vue@5.2.4(vite@6.4.2(@types/node@24.12.2)(tsx@4.21.0))(vue@3.5.33(typescript@5.9.3))':
  ...
  nanoid@3.3.11:
    nanoid: private
  packages/ai-service:
    '@autobs/ai-service': private
  packages/browser-pool:
    '@autobs/browser-pool': private
  packages/core:
    '@autobs/core': private
  packages/image-processor:
    '@autobs/image-processor': private
  packages/logger:
    '@autobs/logger': private
  packages/pipeline:
    '@autobs/pipeline': private
  packages/prompt-repo:
    '@autobs/prompt-repo': private
  packages/storage:
    '@autobs/storage': private
  packages/task-orchestrator:
    '@autobs/task-orchestrator': private
  ...
  vite-node@2.1.9(@types/node@24.12.2):
    vite-node: private
  vite@6.4.2(@types/node@24.12.2)(tsx@4.21.0):
    vite: private
...
pendingBuilds: []
prunedAt: Wed, 29 Apr 2026 02:12:03 GMT
publicHoistPattern: []
registries:
